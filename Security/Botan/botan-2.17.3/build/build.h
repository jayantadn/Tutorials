...
* 'configure.py --cc=gcc --os=mingw --prefix=X:\Tutorials\Security\Botan\botan-bin'
*
* Target
...
#define BOTAN_VERSION_VC_REVISION "git:995d105a468ce8d95d18c17cdbefac7ba2e0c762"
...
#define BOTAN_INSTALL_PREFIX R"(X:\Tutorials\Security\Botan\botan-bin)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(X:\Tutorials\Security\Botan\botan-bin\lib)"
