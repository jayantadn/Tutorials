#ifndef	_CPP_COMPOSITE_MENUS_MENU_HPP_
#define _CPP_COMPOSITE_MENUS_MENU_HPP_
...
class Menu : public MenuComponent {
	...
	public: Menu( const std::string name, const std::string description ) :	_name( name ), _description( description ) {
	}
