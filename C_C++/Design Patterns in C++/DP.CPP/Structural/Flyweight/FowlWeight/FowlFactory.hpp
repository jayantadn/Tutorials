#ifndef	_CPP_FLYWEIGHT_FOWLWEIGHT_FOWL_FACTORY_HPP_
#define _CPP_FLYWEIGHT_FOWLWEIGHT_FOWL_FACTORY_HPP_

#include "FowlWeight.hpp"

// Flyweight Factory

// As also mentioned by GoF we could omit the operation getBird() and
